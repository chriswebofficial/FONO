  ...
  return (
    <div>
      <div className="animated-bg min-h-screen flex items-center justify-center px-6">
        <div className="max-w-3xl bg-white/80 backdrop-blur-lg shadow-xl rounded-xl p-10 text-center">
          ...
          {/* Warning Box */}
          <div className="bg-yellow-50 border border-yellow-200 text-yellow-700 p-4 rounded-lg mb-6 text-sm">
