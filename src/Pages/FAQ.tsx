...
const faqData: FAQItem[] = [
  {
    question: "What is Fono?",
    answer:
      "Fono is a modern mobile retail brand offering smartphones, accessories, and stylish mobile covers with top-notch quality.",
  },
  {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <input
              ...
              className="w-full border-2 border-gray-300 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
            />
          </div>
