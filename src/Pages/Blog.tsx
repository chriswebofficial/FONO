    ...
    <div className="min-h-screen pt-24 px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">FONO Blog</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-gray-50 rounded-xl p-6 mb-8">
              <h3 className="text-xl font-bold mb-6 pb-3 border-b">Featured Posts</h3>
            ...
            {/* Categories */}
            <div className="bg-gray-50 rounded-xl p-6 mb-8">
              <h3 className="text-xl font-bold mb-6 pb-3 border-b">Categories</h3>
              <ul className="space-y-3">
                {categories.slice(1).map((category) => (
                  <li key={category}>
                    <button
                      onClick={() => setSelectedCategory(category)}
                      className={`flex items-center justify-between w-full p-2 rounded-lg hover:bg-white ${
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              <h3 className="text-xl font-bold mb-6 pb-3 border-b">Popular Tags</h3>
              <div className="flex flex-wrap gap-2">
                {popularTags.map((tag) => (
                  <button
                    key={tag}
                    onClick={() => setSearchQuery(tag)}
                    className="px-3 py-2 bg-white border text-sm rounded-lg hover:bg-black hover:text-white hover:border-black transition-colors"
                  >
                    {tag}
                  </button>
                ))}
