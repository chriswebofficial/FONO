...
const About = () => {
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      review:
        "Fono has the best mobile covers I’ve ever purchased. The quality is excellent and delivery was super fast!",
    },
    {
      name: "Grace M.",
      role: "Verified Customer",
      ...
      rating: 4,
      review:
        "Affordable prices and genuine products. I highly recommend Fono for anyone looking for reliable accessories.",
    },
    {
      name: "James K.",
      role: "Verified Customer",
  ...
  return (
    <div className="bg-gray-50">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Fono is a modern mobile retail brand focused on delivering
      ...
      {/* Mission & Vision */}
      <section className="bg-white py-16 px-6 animate-fadeUp">
      ...
      <section className="bg-gray-100 py-20 px-6 animate-fadeUp">
