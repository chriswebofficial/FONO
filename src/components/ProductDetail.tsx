...
const ProductDetail = () => {
  ...
  return (
    <div className="min-h-screen pt-24 px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        {/* Breadcrumb */}
        <nav className="text-sm text-gray-600 mb-8 flex items-center flex-wrap gap-2">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          {/* Image */}
          <div className="bg-gray-50 rounded-xl overflow-hidden p-6 md:p-8">
          ...
          {/* Product Info */}
          <div>
            <span className="inline-block px-3 py-1 bg-gray-100 text-gray-800 text-xs rounded-full mb-4">
              {product.category}
            </span>
            ...
            <div className="flex items-center mb-6">
              ...
              <span className="ml-4 px-2 py-1 bg-green-100 text-green-800 text-xs rounded">
                In Stock
              </span>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="flex-1 bg-black text-white py-3 px-6 rounded-lg hover:bg-gray-800 flex items-center justify-center font-medium">
                  <FiShoppingCart className="mr-2" />
                  Add to Cart
                </button>
                <button className="flex-1 border-2 border-black text-black py-3 px-6 rounded-lg hover:bg-gray-50 flex items-center justify-center font-medium">
